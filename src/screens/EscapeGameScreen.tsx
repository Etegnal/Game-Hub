  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <DynamicIsland title="🕹️ KAÇIŞ OYUNU" subtitle="Refleks Laboratuvarı" badge="YAKINDA" />

        <View style={styles.content}>
          <Text style={styles.emoji}>🚧</Text>
          <Text style={styles.title}>Yapım Aşamasında</Text>
          <Text style={styles.description}>
            Engellerden sıyrılarak en uzun süre hayatta kalmaya çalışacağınız Kaçış Oyunu çok yakında burada olacak!
          </Text>
